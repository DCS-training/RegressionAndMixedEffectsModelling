---
title: "Regression and Mixed-effects Modelling in R : Session 3"
...
ggplot(data_ISD, aes(x=Prime, fill= as.factor(Response))) +
...
Perhaps the most intuitive advice would be remove the most complex part of the 
